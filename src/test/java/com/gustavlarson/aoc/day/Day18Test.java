...
public class Day18Test {
    ...
    @Test
    public void testPart112() {
        final List<String> input = List.of("((1 + 1) + (1 + 1)) + 2 * 3 ");
        final Day day = getDay(input);
        assertEquals(18, day.solvePart1());
    }

    @Test
    public void testPart113() {
        final List<String> input = List.of("(4 * 2 + 5 + 5 * (7 + 6) + 5) * 6");
        final Day day = getDay(input);
        assertEquals(1434, day.solvePart1());
    }
    ...
    public void testPart201() {
        final List<String> input = List.of("1 + 2 * 3 + 4 * 5 + 6");
        final Day day = getDay(input);
        assertEquals(231, day.solvePart2());
    }
    ...
    public void testPart202() {
        final List<String> input = List.of("1 + (2 * 3) + (4 * (5 + 6))");
        final Day day = getDay(input);
        assertEquals(51, day.solvePart2());
    }
    ...
    public void testPart203() {
        final List<String> input = List.of("2 * 3 + (4 * 5)");
        final Day day = getDay(input);
        assertEquals(46, day.solvePart2());
    }
    ...
    public void testPart204() {
        final List<String> input = List.of("5 + (8 * 3 + 9 + 3 * 4 * 3)");
        final Day day = getDay(input);
        assertEquals(1445, day.solvePart2());
    }
    ...
    public void testPart1Real() {
        ...
        final Day day = getDay(input);
        assertEquals(67800526776934L, day.solvePart1());
    }
    ...
    public void testPart2Real() {
        final List<String> input = getFromFile(18);
        final Day day = getDay(input);
        assertEquals(340789638435483L, day.solvePart2());
    }
}
